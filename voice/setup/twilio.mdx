...
Integrate **Twilio** with the Voice Suite to enable seamless phone number management and real-time calling. Follow the steps below to configure Twilio in your TIXAE dashboard.  

---

## 🛠 Step 1: Access the Voice Setup Page  

1. Navigate to the **Voice Setup** page in the TIXAE dashboard.  
...
- TIXAE Voice charges **10 credits per minute** for Twilio calls.  
