...
description: "Learn how to configure speech generation in TIXAE Voice Suite."
icon: "waveform"
---

Learn how to configure **Speech Generation** in the TIXAE Voice Suite. Use providers like **ElevenLabs** to generate human-like speech responses with customizable options for tone, background noise, and punctuation breaks.
