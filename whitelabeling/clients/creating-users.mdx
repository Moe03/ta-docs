...
Adding users to your client organizations is a crucial step in setting up effective client management in TIXAE Agents. This guide will walk you through the process of creating and managing users for your client organizations.

## Accessing User Management

<Steps>
  <Step title="Navigate to Client Tab">
    Go to the `Client` tab in your TIXAE Agents dashboard.
  </Step>
