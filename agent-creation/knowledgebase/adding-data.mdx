...
## Adding Data to the Knowledge Base
    ...
    Orova Agents offers multiple methods to populate your knowledge base with data: 
...
Orova Agents offers multiple methods to populate your knowledge base with data. Follow the steps below for each method:
