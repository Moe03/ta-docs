...
description: 'Learn how to craft effective prompts for your agents in TIXAE AI'
---
...
#
AI thrives on context. In TIXAE Agents, context comes from three primary sources: system prompt, user input, and the built-in knowledgebase.
...
<Steps>
  ...
  <Step title="Leverage the Knowledge Base">
    TIXAE Agent's knowledge base provides a layer of information on top of the model's training data, ensuring consistent and accurate responses.
  </Step>
