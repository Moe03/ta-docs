---
title: 'Overview'
description: 'Guide to integrating Voiceflow with TIXAE Agents, including analytics, templates, and library components.'
icon: tree
---

## Introduction
This documentation covers the integration of Voiceflow with [TIXAE Agents](https://voiceglow.org/). Learn how to connect your Voiceflow projects, access analytics, and leverage templates and library components for better performance.

### Prerequisites
- [Voiceflow](https://www.voiceflow.com/) account and access to your project dashboard.
- **Agent ID** and **Project ID** from Voiceflow.
- Access to the [TIXAE Agents](https://voiceglow.org/) platform.
...
### Step 2: Configure in TIXAE
1. Navigate to the [TIXAE Agents](https://voiceglow.org/) page and choose your agent.
...
![TIXAE Integration](/images/voiceflow/2.gif)
...
### Accessing Analytics
- Go to your TIXAE agent dashboard.
...
- Locate the VG template in the **[TIXAE Agents](https://voiceglow.org/)** profile section or download it directly from [here](https://cdn.voiceglow.org/public/VGLatestTemplate.vf).
