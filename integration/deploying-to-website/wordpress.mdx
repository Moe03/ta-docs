---
title: 'WordPress'
description: 'Integrate your Orova Agent into your WordPress website.'
icon: wordpress
---
...
There are three main ways to integrate your Orova Agent widget into WordPress:
...
## Orova Agent Widget Code

Before proceeding with any method, you'll need your Orova Agent widget code:
...
<Steps>
  ...
  <Step title="Add Widget Code">
    Paste the Orova Agent widget code in the header section
  </Step>
...
<Steps>
  ...
  <Step title="Add Widget Code">
    Paste the Orova Agent widget code just before the closing `</head>` tag
  </Step>
  <Step title="Save Changes">
...
<Steps>
  ...
  <Step title="Configure Custom Code">
    ...
    4. Paste the Orova Agent widget code in the code block editor
  </Step>
...
<Note>
  If you're using a security plugin, make sure it's not blocking the Orova Agent scripts from loading.
</Note>