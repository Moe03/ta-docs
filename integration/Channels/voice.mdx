---
title: "Connect Vapi"
description: "Connect your Vapi account to your AI agent on Orova Agents."
icon: "microphone" 
---

# Vapi Voice Service Integration

Welcome to the Orova Agents Vapi Voice Service integration guide! This document will help you quickly connect and configure the Vapi Voice Service with Orova Agents, allowing you to leverage voice interactions powered by AI.
...
## Why Integrate Vapi with Orova Agents?
...
By integrating Vapi with Orova Agents, you can:
...
1. An active [Orova Agents](https://voiceglow.org/) account with permissions to integrate third-party services.
2. Access to a [Vapi Voice Service](https://dashboard.vapi.ai/) account.

---

## Steps to Integrate Vapi with Orova Agents
...
### Step 2: Configure Orova Agents for Vapi Integration

1. Log in to your [Orova Agents](https://voiceglow.org/) account.
...
### Step 4: Configure Voice Setup for the Agent on Orova Agents

1. On your [Orova Agents](https://voiceglow.org/) platform, select the **agent** you want to integrate with Vapi.
...
- This tutorial video provides a comprehensive guide on connecting VAPI to your Orova agent:
...
- **API Key errors:** Double-check that you entered the correct **Public** and **Private API Keys** in both the Vapi and Orova Agents platforms. Ensure there are no spaces or missing characters
