...
> If this page shows up then **you've successfully setup your github pages site**, you can now use this link to host your Orova Agents agent or any other static site files as well.
...
<!-- Here is where Orova Agents renders the widget. -->
...
> Head to Orova Agents dashboard > **credentials tab with the key icon** > **Paste your github username and the token you've generated.**
